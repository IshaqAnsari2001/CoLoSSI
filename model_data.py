...
ALoc = {}  # A -> Accessible locations names / Aliases
ALOCS = [] # Locations
DUMMIES = ['START','END']
CELLS = []
initLoc = {} # Initial locations   Agent -> aliase
riLoc = {}  # related locations :: Cells -> list of Aliases
rLoc = {}   #   Dictionary Aliase -> Cell
expl = {}   # Efficacy dictionary   (Agent, aliase,task) -> number
ADJ = {} # Maps aliase -> list of adjacent locs
maxTime = 0
# Read distances
d_matrix = {}
coos = {}
