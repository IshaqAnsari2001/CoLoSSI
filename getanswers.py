...
def get_cmd(dataset, numOfAgent, interval):
    return (f'INSTANCES/comp_L20-R1-{dataset}_mth_n{numOfAgent}t4-1_s2_tw1000.mdata nomeetup {interval} {args[2]}')
...
if __name__ == "__main__":
    ...
    for count in range(len(dataset)):
        ...
        for i in range(len(agents)):
            ...
            array.append(min(temp))

        print(f"\n\n=======>>> Answer for all agents for {dataset[count]} dataset is after {repeat} repititions:::: ", array)
        print("\n\n")